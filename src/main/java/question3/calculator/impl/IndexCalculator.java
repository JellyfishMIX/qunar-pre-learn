 ...
 * @date 7/6/22 02:06
 */
public class IndexCalculator extends Calculator {
    /**
     * 排好序的 List
     */
    private List<PropLine> sortedList;

    public IndexCalculator(ImmutableList<PropLine> propLineImmutableList) {
        super(propLineImmutableList);
        // 开始排序
        List<PropLine> propLineList = Lists.newArrayList(propLineImmutableList);
        propLineList.sort((a, b) -> a.getIndex() - b.getIndex());
